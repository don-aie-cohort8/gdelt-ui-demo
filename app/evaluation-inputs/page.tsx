...
import { Database, Loader2, AlertCircle, Search, ChevronLeft, ChevronRight, ExternalLink, MessageSquare, Bot, Target, Layers } from "lucide-react"
...
import { useEvaluationInputs } from "@/hooks/use-datasets"

const PAGE_SIZE = 10

export default function EvaluationInputsPage() {
  const [offset, setOffset] = useState(0)
  const [search, setSearch] = useState("")
  const [searchInput, setSearchInput] = useState("")

  // Use React Query hook for data fetching
  const { data, isLoading, error } = useEvaluationInputs(offset, PAGE_SIZE, search)
            ...
            <main className="flex-1 p-6">
              <div className="flex min-h-[400px] items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-sm text-muted-foreground">Loading evaluation inputs...</p>
                </div>
              </div>
            </main>
          </div>
          ...
          <main className="flex-1 p-6 space-y-6">
            ...
            <div>
              <div className="flex items-center gap-2 mb-2">
                ...
                <h1 className="text-3xl font-bold">Evaluation Inputs</h1>
              </div>
              <p className="text-muted-foreground">
                Browse the {total.toLocaleString()} evaluation records from 5 retrieval strategies.
              </p>
            </div>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-lg">Search Evaluation Inputs</CardTitle>
                <CardDescription>
              ...
              <CardContent>
                <div className="flex gap-2">
                  <div className="relative flex-1">
                    ...
                    <Input
                      placeholder="Search evaluation inputs..."
                      value={searchInput}
            ...
            <div className="grid gap-4 md:grid-cols-4">
              ...
              <Card>
                ...
                <CardContent>
                  <a
                    href="https://huggingface.co/datasets/dwb2023/gdelt-rag-evaluation-inputs"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-sm text-primary hover:underline flex items-center gap-1"
                  >
                    gdelt-rag-evaluation-inputs
