/**
 * API endpoint for GDELT evaluation metrics browser
 * Fetches data from HuggingFace: dwb2023/gdelt-rag-evaluation-metrics
 */

import { NextResponse } from "next/server"
import { fetchHFDataset, parseContextArray, type EvaluationMetricResponse } from "@/lib/huggingface"
import type { EvaluationMetricRow } from "@/lib/types"

const EVAL_METRICS_DATASET = "dwb2023/gdelt-rag-evaluation-metrics"
...
export async function GET(request: Request) {
  ...
  try {
    ...
    const data = await fetchHFDataset<EvaluationMetricRow>(
      EVAL_METRICS_DATASET,
      "default",
      "train",
      offset,
      length
